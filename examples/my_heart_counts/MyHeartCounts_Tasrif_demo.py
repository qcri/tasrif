...
# +
import os
from tasrif.processing_pipeline import SequenceOperator, MapProcessingOperator, ComposeOperator
from tasrif.processing_pipeline.pandas import ConcatOperator, RenameOperator, ConvertToDatetimeOperator, GroupbyOperator, DropNAOperator
from tasrif.processing_pipeline.custom import ReadCsvFolderOperator, AggregateOperator, ResampleOperator, FilterOperator, SetStartHourOfDayOperator
...
op = AggregateOperator(groupby_feature_names=['recordId', 'type'],
...
swo = SlidingWindowOperator(winsize="1h15t",
                           time_col="startTime",
                           label_col="value",
                           participant_identifier="recordId")
