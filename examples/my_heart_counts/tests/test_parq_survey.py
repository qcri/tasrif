...
def test_data_is_correctly_loaded(df):
    ...
    assert(columns == [
        'appVersion', 'chestPain', 'chestPainInLastMonth',
        'createdOn', 'dizziness', 'healthCode',
        'heartCondition', 'jointProblem', 'phoneInfo',
        'physicallyCapable', 'prescriptionDrugs', 'recordId'
    ])
