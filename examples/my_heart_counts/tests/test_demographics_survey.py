...
def test_data_is_correctly_loaded(df):
    ...
    assert(columns == [
        'appVersion', 'createdOn', 'healthCode', 'patientBiologicalSex',
        'patientCurrentAge', 'patientGoSleepTime', 'patientHeightInches',
        'patientWakeUpTime', 'patientWeightPounds', 'phoneInfo', 'recordId'
    ])
