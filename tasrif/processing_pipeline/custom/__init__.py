...
from tasrif.processing_pipeline.custom.flag_patient_if_not_enough_days_operator import FlagPatientIfNotEnoughDaysOperator
...
from tasrif.processing_pipeline.custom.flag_day_if_day_sum_smaller_than_operator import FlagDayIfDaySumSmallerThanOperator
